...
public extension UIView {
    ...
    /// AK: Border color of view; also inspectable from Storyboard.
    ...
    /// AK: Border width of view; also inspectable from Storyboard.
    ...
    /// AK: Corner radius of view; also inspectable from Storyboard.
    ...
    /// AK: Check if view is in RTL format.
    ...
    /// AK: Take screenshot of view (if applicable).
    ...
    /// AK: Shadow color of view; also inspectable from Storyboard.
    ...
    /// AK: Shadow offset of view; also inspectable from Storyboard.
    ...
    /// AK: Shadow opacity of view; also inspectable from Storyboard.
    ...
    /// AK: Shadow radius of view; also inspectable from Storyboard.
    ...
    /// AK: Get view's parent view controller
...
public extension UIView {
    ...
    /// AK: Recursively find the first responder.
    ...
    /// AK: Set some or all corners radiuses of view.
    ///
    /// - Parameters:
    ...
    /// AK: Add array of subviews to view.
    ///
    ...
    /// AK: Remove all subviews in view.
    public func removeSubviews() {
        subviews.forEach({ $0.removeFromSuperview() })
    }
    
    /// AK: Remove all gesture recognizers from view.
    public func removeGestureRecognizers() {
        gestureRecognizers?.forEach(removeGestureRecognizer)
    }
    
    /// AK: Attaches gesture recognizers to the view.
    ///
    ...
    /// AK: Detaches gesture recognizers from the receiving view.
    ///
    ...
    /// AK: Rotate view by angle on relative axis.
    ///
    /// - Parameters:
    ...
    /// AK: Rotate view to angle on fixed axis.
    ///
    /// - Parameters:
    ...
    /// AK: Add Visual Format constraints.
    ///
    /// - Parameters:
    ...
    /// AK: Anchor all sides of the view into it's superview.
    ...
    /// AK: Add anchors from any side of the current view into the specified anchors and returns the newly added constraints.
    ///
    /// - Parameters:
    ...
    /// AK: Anchor center X into current view's superview with a constant margin value.
    ///
    ...
    /// AK: Anchor center Y into current view's superview with a constant margin value.
    ///
    ...
    /// AK: Anchor center X and Y into current view's superview
    ...
    /// AK: Search all superviews until a view with the condition is found.
    ///
    ...
    /// AK: Search all superviews until a view with this class is found.
    ///
