...
#if !os(Linux)
// MARK: - Properties
/// AK: Common usefull properties and methods.
public struct AK {
    
    #if !os(macOS)
    /// AK: App's name (if applicable).
    ...
    #if !os(macOS)
    /// AK: App's bundle ID (if applicable).
    ...
    #if !os(macOS)
    /// AK: App current build number (if applicable).
    ...
    #if os(iOS) || os(tvOS)
    /// AK: Application icon badge current number.
    ...
    #if !os(macOS)
    /// AK: App's current version (if applicable).
    ...
    #if os(iOS) || os(tvOS)
    /// AK: Shared instance of current device.
    ...
    #if os(iOS)
    /// AK: Current orientation of device.
    ...
    /// AK: Check if app is running in debug mode.
    ...
    #if !os(macOS)
    /// AK: Check if app is running in TestFlight mode.
    ...
    #if os(iOS)
    /// AK: Check if multitasking is supported in current device.
    ...
    #if os(iOS)
    /// AK: Current status bar network activity indicator state.
    ...
    #if os(iOS) || os(tvOS)
    /// AK: Check if device is registered for remote notifications for current app (read-only).
    public static var isRegisteredForRemoteNotifications: Bool {
        return UIApplication.shared.isRegisteredForRemoteNotifications
    }
    #endif
    
    /// AK: Check if application is running on simulator (read-only).
    ...
    #if os(iOS)
    /// AK: Status bar visibility state.
    ...
    #if os(iOS) || os(tvOS)
    /// AK: Key window (read only, if applicable).
    ...
    #if os(iOS) || os(tvOS)
    /// AK: Most top view controller (if applicable).
    ...
    #if os(iOS) || os(tvOS)
    /// AK: Shared instance UIApplication.
    ...
    #if os(iOS)
    /// AK: Current status bar style (if applicable).
    ...
    #if !os(macOS)
    /// AK: System current version (read-only).
...
public extension AK {
    ...
    /// AK: Delay function or closure call.
    ///
    /// - Parameters:
    ...
    /// AK: Debounce function or closure call.
    ///
    /// - Parameters:
    ...
    #if os(iOS) || os(tvOS)
    /// AK: Called when user takes a screenshot
    ///
    ...
    /// AK: Class name of object as string.
    ///
