...
public extension UITextField {
    ...
    /// AK: Set textField for common text types.
    ...
    /// AK: Check if text field is empty.
    public var isEmpty: Bool {
        return text?.isEmpty == true
    }
    
    /// AK: Return text with no spaces or new lines in beginning and end.
    public var trimmedText: String? {
        return text?.trimmingCharacters(in: .whitespacesAndNewlines)
    }
    
    /// AK: Check if textFields text is a valid email format.
    ///
...
public extension UITextField {
    ...
    /// AK: Add padding to the left of the textfield rect.
    ///
